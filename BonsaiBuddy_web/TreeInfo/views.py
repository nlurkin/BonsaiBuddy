...
class DetailView(TreeInfoMenuMixin, View):
    ...
    def build_technique_table(self, tree):
        ...
        all_objectives = {
            (
                _.objective_f.sequence,
                _.objective_f.short_name,
            ): _.objective_f.display_name
        ...
        for association in tech_associations:
            ...
            similar = [
                _ for _ in tech_associations if _.technique == association.technique
            ]
...
class TreeInfoViewSet(viewsets.ModelViewSet, APIUnquoteMixin):
    ...
    permission_classes = [IsAuthenticatedOrReadOnly, TreeInfoPermissionModelAPI]
