...
class ReqAdviceInfo():
        ...
        def is_complete(self):
            ...
            descriptors = (self.tree is not None and self.objective is not None and (self.period is not None or self.stage is not None))
...
class AdviceConfigForm(forms.Form):
    ...
    stage           = forms.MultipleChoiceField(label="Stage", choices=build_stage(), widget=TagifyWidget, required=False)
